...
ATTENDEES_FILE = '/home/cloud/bcard/2024-Digital-Business-Cards-Info_v1.0.xlsx'
...
for i, user in df.iterrows():
    details = {
        ...
        'email': user.iloc[2],
        # 'phone': user.iloc[5].strip("'") if user.iloc[5],
...
for employee in sales:
    if User.objects.filter(username=employee['username']):
        ...
        skipped_employees.append((employee['first_name'], employee['last_name'], employee['email']))
        continue
